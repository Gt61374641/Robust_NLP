...
class ArgParser():
    def __init__(self):
        ...
        dataset_list = ['sst2', 'imdb', 'rotten', 'cr', 'yelp_polarity', 'amazon_polarity', 'tweet_sentiment_binary',
                        'financial_phrasebank', 'sst5', 'ag_news',
        ...
        self.parser.add_argument('--data_path', type=str, default=f'./data/dataset',
                                 help='Path to the dataset.')
        self.parser.add_argument('--preprocess_path', type=str, default=f'./data/preprocessed/{self.proj_name}',
                                 help='Path to the preprocessed dataset.')
        self.parser.add_argument('--model_path', type=str, default=f'./data/model_final/{self.proj_name}',
                                 help='Path to the model after training.')
        self.parser.add_argument('--checkpoint_path', type=str, default=f'./data/model_checkpoint/{self.proj_name}')
        self.parser.add_argument('--result_path', type=str, default=f'./results/{self.proj_name}',
                                 help='Path to the result after testing.')
        self.parser.add_argument('--log_path', type=str, default=f'./data/tensorboard_log/{self.proj_name}',
        ...
        model_type_list = ['bert', 'roberta', 'roberta_large', 'distilbert', 'tinybert', 'lstm', 'cnn', # Classification Model
                           'gpt2', 'gpt2_large', 'gpt2_xl', 'opt', 'bloom', # Generation Model (Causal LM)
                           'llama_1b', 'llama_3b', 'qwen_1_5b', 'phi_3_5'] # Generation Model (Instruction-tuned)
        ...
        self.parser.add_argument("--use_4bit", type=parse_bool, default=False,
                                 help="Whether to use 4-bit quantization for generation models.")
        self.parser.add_argument("--gen_model_type", type=str, default=None,
                                 help="Generator model type for file naming; defaults to model_type if not set.")
