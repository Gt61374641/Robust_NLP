...
INSTRUCTION_MODELS = ['llama_1b', 'llama_3b', 'qwen_1_5b', 'phi_3_5']
...
class GenerationDataset(Dataset):
    def __init__(self, args, label:int) -> None:
        ...
        if self.tokenizer.pad_token is None:
            self.tokenizer.pad_token = self.tokenizer.eos_token
        self.is_instruction_model = args.model_type in INSTRUCTION_MODELS
    ...
    def build_chat_prompt(self, stage:int, input_text:str=None, label:str=None, topic:str=None) -> str:
        raw_prompt = self.build_prompt(stage=stage, input_text=input_text, label=label, topic=topic)
